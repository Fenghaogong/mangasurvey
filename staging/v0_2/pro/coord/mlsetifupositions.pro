...
ha=lst-objra/15.
;ha=lst-obsparam.cenra/15.
print,objra,objdec,ha,lst,' ',obsparam.taistart

for j=0,nwave-1 do begin
  dar=mldar(ha,objdec,wave[j],parang,xdar,ydar,alt,waveREF=5500.,TC=obsparam.tcel,RH=obsparam.rhumid,P=obsparam.pres)
;  dar=mldar(ha,obsparam.cendec,wave[j],parang,xdar,ydar,alt,waveREF=5500.,TC=obsparam.tcel,RH=obsparam.rhumid,P=obsparam.pres)
...
;  print,wave[j],obsparam.tcel,obsparam.rhumid,obsparam.pres,xdar,ydar
  xdar=-xdar

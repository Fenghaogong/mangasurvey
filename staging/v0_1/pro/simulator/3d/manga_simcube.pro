...
pro manga_simcube, InpCubeFile, pixscaleI, InpWaveFile, wavestart, wavestop, xobj=xobj, yobj=yobj, CCDfile=CCDfile, RSSfile=RSSfile, OutpFile=OutpFile, OutpWaveFile=OutpWaveFile, sobfile=sobfile, spiral=spiral, debug=debug, verbose=verbose, ctflux=ctflux, nospecsmooth=nospecsmooth
  ; 32-bit integers
...
for k=0,nwave-1 do begin
  ...
  ; Emperically, using rlim=1.6'' and sigma=0.7 arcsec gives

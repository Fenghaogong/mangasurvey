...
pro fcpsf1d, psfpara, ha, dec, xfocal, yfocal,psfplane,wavearr=wavearr,xarr=xarr,pixelscale=pixelscale,magnify=magnify,aperture=aperture,debug=debug,resetwave=resetwave
...
;  convolve with fiber size 2"
   ...
   psfplane = fltarr(n_elements(outindex),nwave)
   for i=0,nwave-1 do begin
...
if keyword_set(debug) then begin
   save,psfcube,cube2,psfplane,filename='fcpsfplane.sav'      
endif
   xarr = x1[outindex]
;   cube = shcube 

...
;-
; Tweaked Dec 20 2012 by D.R. Law
; now returns new string instead.

function mlSTRREPLACE, Strings, Find1, Replacement1
...
;   Check integrity of input parameter
         ...
         if (nreplace eq 0) then return,newstring
         ...
         for i=0,nreplace-1 do begin
              ...
              newstring(j) = prefix + replacement + suffix
           endfor
return,newstring
end

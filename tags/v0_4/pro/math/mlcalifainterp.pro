...
function mlcalifainterp, coordX, coordY, F_in, fiber_status, dim_out, rlim, sigma,dostop=dostop
...
for i=0,ntot-1 do $
   r_image += F_in[i] * arr_weights[*,*,i] / matr_norm / (rlim*rlim*!DPI)

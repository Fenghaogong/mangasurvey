...
;;                  I0_Dev = I0_Dev, I0_Exp = I0_Exp, mgeout = mgeout, hdr_mgeout = hdr_mgeout
;;
;; ARGUMENTS: 
...
;;
;; KEYWORDS:
;;   I0_Dev           Intrinsic de Vaucouleurs profile normalizations, defined as the surface brightness at Re (not calculated if input)
;;   I0_Exp           Intrinsic Exponential profile normalizations, defined as the surface brightness at Re (not calculated if input)
...
if n_params() EQ 0 then begin
   ...
   print, '       I0_Dev=, I0_Exp=, mgeout=, hdr_mgeout=
   return
endif
...
if not(keyword_set(I0_Exp)) then I0_Exp = fltarr(nmags)-1
if not(keyword_set(I0_Dev)) then I0_Dev = fltarr(nmags)-1

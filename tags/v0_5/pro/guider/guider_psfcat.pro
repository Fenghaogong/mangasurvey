...
pro guider_psfcat
   ...
   zerocat={mjd:0L,exposure:0L,plate:0,flatcart:0,dcnra:0.0,dcndec:0.0,params:dblarr(4),fwhm:0.0,transpar:0.0,guider1:' ',guidern:' ',SEXPTIME:0.0,GEXPTIME:0.0,ra:0.0d, dec:0.0d, ha:0.0d,alt:0.0d,az:0.0d}

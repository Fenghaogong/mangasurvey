...
;; your IDL terminal.  Please refer to Bundy et al. 2012 and kindly cite this reference when using the SYNMAG software.
;;
...
;; --------------------------------------------------
;;   SYNMAG.PRO is designed to be fairly general, so that it can be applied to a variety of datasets.  In addition to this
;;   routine, SDSS_TO_SYNMAG.PRO is specific to the purpose of measuring SYNMAGs using SDSS data.  
;;   Specific information about the calling sequence, arguments, and keywords are provided in the SYNMAG.PRO header.  
;;
...
;; Define a single-component gaussian PSF and assume it is the same for each object
...
;;   Note: By default, the synmag flux normalization integrates to infinity, introducing 0.01-0.02 mag offsets

...
;       Revised filepath for cal files, require providing output filename
;   v1.3: 15-Feb-2013 D. Law
;       Revised to add extensions to spCFrame where all info is
;       rectified to same wave solution.
;   v1.4: 24-Jun-2013 D. Law
;       Added option to print plots to a file.  Added AB mag extension.
;-
...
function mlfluxcal,fileb1,filer1,Cfile1,obsparam,slitmap,waveset,plotfile=plotfile
...
for ifile=0, nfile-1 do begin
  ...
  ; Figure out write directory
  datapath=file_dirname(fileb1)

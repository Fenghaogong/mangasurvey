...
;l241 set keyword for fitflatwidth
function configuration::spcalib_fitflatwidth_inmask,flux,fluxivar,ntrace
  if self->isSDSS2() then return, 0
  return, reform(self->spcalib_fitflatwidth_mask(flux,fluxivar),(size(flux,/dimen))[0],ntrace)
end
